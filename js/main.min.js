...
/* harmony import */ var _modules_price_format__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/price-format */ "./js/modules/price-format.js");
/* harmony import */ var _modules_nav_toggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/nav-toggle */ "./js/modules/nav-toggle.js");
/* harmony import */ var _modules_init_video__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-video */ "./js/modules/init-video.js");
/* harmony import */ var _modules_init_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-slider */ "./js/modules/init-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_video__WEBPACK_IMPORTED_MODULE_6__["initPlayVideo"])();
    Object(_modules_nav_toggle__WEBPACK_IMPORTED_MODULE_5__["initMenu"])();
    ...
    Object(_modules_price_format__WEBPACK_IMPORTED_MODULE_4__["priceFormat"])();
    Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_7__["initSlider"])();
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_3__["initFormValidate"])();
  });
}); // ---------------------------------
...
/*!**********************************!*\
  !*** ./js/modules/init-video.js ***!
  \**********************************/
/*! exports provided: initPlayVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPlayVideo", function() { return initPlayVideo; });
var initPlayVideo = function initPlayVideo() {
...
var initMenu = function initMenu() {
  ...
  if (header) {
    ...
    var sideBarWrapper = document.querySelector('.side-bar__wrapper');
    var sideBarList = document.querySelectorAll('.side-bar__list');
    var wrapper = document.querySelector('.wrapper');

    var closeMenu = function closeMenu() {
      navToggle.classList.remove('nav-toggle--opened');
      sideBarWrapper.classList.remove('side-bar__wrapper--opened');
    ...
    var openMenu = function openMenu() {
      ...
      sideBarWrapper.classList.add('side-bar__wrapper--opened');
    ...
    navToggle.addEventListener('click', function (evt) {
      ...
      if (navToggle.classList.contains('nav-toggle--opened')) {
        closeMenu();
      } else {
        openMenu();
      }
...
var priceFormat = function priceFormat() {
  var prices = document.querySelectorAll('[data-price], [data-total-sum]');
  ...
  prices.forEach(function (item) {
    ...
    var price = Number.prototype.toFixed.call(parseFloat(value) || 0);
    item.textContent = price.replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1 ');
  });
};
